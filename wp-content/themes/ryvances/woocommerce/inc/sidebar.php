    ...
    ?>
        <div class="flex items-center justify-between gap-2">
          <a href="<?php echo esc_url($term_link); ?>" class="flex items-center gap-2">
            <h3 class="text-sm md:text-base font-medium hover:text-btn-primary transition-all duration-300 <?php echo $is_current ? 'text-btn-primary' : 'text-gray-900'; ?>" style="<?php echo $is_current ? 'display: list-item; list-style-type: disclosure-closed; margin-left: 20px;' : ''; ?>"><?php echo esc_html($term->name); ?></h3>
          </a>
