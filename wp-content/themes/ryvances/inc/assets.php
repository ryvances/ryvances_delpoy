...
{
  wp_enqueue_style('theme-styles', get_template_directory_uri() . '/css/app.css', array(), '1.0.4');
  wp_enqueue_script('theme-scripts', get_template_directory_uri() . '/js/app.js', array('jquery'), '1.0.4', true);
